...
const EmployerLogin = () => {
  ...
  const features = [
    {
      ...
      description: "Skip up to three rounds with 0-100 fit scores from coding tests and real-world assessments.",
    ...
    },
    {
      ...
      description: "Only validated experts surface to your recruiters across permanent, contract & project roles.",
      color: "bg-purple-100 dark:bg-purple-900/50 text-purple-600 dark:text-purple-400"
    },
    {
      icon: TrendingUp,
      title: "Growth for top 1% talent",
      description: "Career path visualization, paid mentorship, and continuous upskilling keep your best engaged.",
  ...
  const stats = [
    ...
    { value: "3x", label: "Faster deployment from bench" },
    { value: "100%", label: "Skills verified before interview" }
  ];
