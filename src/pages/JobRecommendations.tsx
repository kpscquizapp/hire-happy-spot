    ...
    const getRecommendations = () => {
      let scored = jobListings.map(job => {
        ...
        if (user.lookingForContract) {
          if (job.type.en.toLowerCase().includes('contract') || 
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
                Based on your preferences{user.lookingForContract ? ' for contract work' : ''}, 
                skills, and experience, we've found these opportunities
              </p>
            </div>
