  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-slate-50 dark:bg-black">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-4 sm:py-6 space-y-4 sm:space-y-6 animate-fade-in">
        ...
        <div className="space-y-6">
          {/* Policy Alert */}
          <Card className="border-0 shadow-sm rounded-xl sm:rounded-2xl overflow-hidden bg-gradient-to-r from-orange-50 to-amber-50 dark:from-orange-950/30 dark:to-amber-950/30">
            <CardContent className="p-3 sm:p-4 flex items-start gap-3">
              <div className="w-8 h-8 rounded-full bg-orange-100 dark:bg-orange-900/50 flex items-center justify-center shrink-0 flex-shrink-0">
                <AlertCircle className="h-4 w-4 text-orange-600 dark:text-orange-400" />
              </div>
              <p className="text-xs sm:text-sm text-orange-800 dark:text-orange-200 leading-relaxed">
                <strong>Bench Policy:</strong> Resources listed here must be on
                your company payroll. Profiles can be anonymized until an
          ...
          <Card className="border-0 shadow-lg rounded-xl sm:rounded-2xl overflow-hidden bg-white dark:bg-slate-900">
            <CardHeader className="pb-3 sm:pb-4 border-b border-slate-100 dark:border-slate-800 bg-gradient-to-r from-slate-50 to-blue-50/50 dark:from-slate-800/50 dark:to-slate-800/30 px-4 sm:px-6 py-3 sm:py-4">
              <div className="flex items-start sm:items-center gap-2 sm:gap-3">
                <div className="w-8 sm:w-10 h-8 sm:h-10 rounded-lg sm:rounded-xl bg-blue-100 dark:bg-blue-900/50 flex items-center justify-center flex-shrink-0">
            ...
            <CardContent className="pt-4 sm:pt-6 space-y-3 sm:space-y-5 p-4 sm:p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-2">
                  ...
                  >
                    <SelectTrigger className="h-10 sm:h-12 rounded-lg sm:rounded-xl text-sm border-slate-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2 mt-2 sm:mt-3">
                  {formData.skills.map((skill) => (
                    <Badge
                      key={skill}
                      className="px-3 py-1.5 sm:px-4 sm:py-2 rounded-full text-xs sm:text-sm bg-gradient-to-r from-blue-500 to-blue-600 text-white hover:from-blue-600 hover:to-blue-700 cursor-pointer shadow-sm shadow-blue-500/30 transition-all"
                    >
                      {skill}
                      <X
                        className="h-3 w-3 ml-1 sm:ml-2 cursor-pointer hover:scale-110 transition-transform"
              ...
              <div className="space-y-2">
                ...
                <Textarea
                  ...
                  rows={4}
                  className="rounded-lg sm:rounded-xl resize-none text-sm border-slate-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 focus:border-blue-500 focus:ring-blue-500/20 dark:focus:border-blue-500"
                />
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent className="pt-4 sm:pt-6 space-y-3 sm:space-y-5 p-4 sm:p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    <Calendar className="absolute left-3 sm:left-4 top-1/2 -translate-y-1/2 h-4 sm:h-5 w-4 sm:w-5 text-slate-400 dark:text-slate-500" />
                    <Input
                      type="date"
                      ...
                      className="pl-10 sm:pl-12 h-10 sm:h-12 rounded-lg sm:rounded-xl text-sm border-slate-200 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-100 focus:border-blue-500 focus:ring-blue-500/20 dark:focus:border-blue-500"
                    />
                  </div>
                </div>
                <div className="space-y-2">
              ...
              <div className="space-y-3">
                ...
                <div className="flex flex-wrap gap-2 sm:gap-4">
                  {[
                    ...
                    <div
                      key={loc.id}
                      className="flex items-center space-x-2 bg-slate-50 dark:bg-slate-800 px-3 sm:px-4 py-2 sm:py-2.5 rounded-lg sm:rounded-xl"
                    >
                      <Checkbox
                        id={loc.id}
                        checked={loc.checked}
                        ...
                        className="border-slate-300 dark:border-slate-600 data-[state=checked]:bg-blue-500 data-[state=checked]:border-blue-500 w-4 h-4"
                      />
                      <label
                        htmlFor={loc.id}
                        className="text-xs sm:text-sm cursor-pointer text-slate-600 dark:text-slate-400 font-medium"
                      >
                        {loc.label}
                      </label>
                    </div>
              ...
              <div className="p-3 sm:p-5 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-lg sm:rounded-2xl border border-blue-100 dark:border-blue-900/50 flex items-start gap-3 sm:gap-4">
                <Checkbox
                  id="non-solicitation"
                  ...
                  className="mt-0.5 border-blue-300 dark:border-blue-700 data-[state=checked]:bg-blue-500 data-[state=checked]:border-blue-500 w-4 h-4 flex-shrink-0"
                />
                <div className="min-w-0">
                  <label
                    htmlFor="non-solicitation"
                    className="text-xs sm:text-sm font-semibold text-slate-800 dark:text-slate-100 cursor-pointer"
                  >
          ...
          {/* Documents */}
          <Card className="border-0 shadow-lg rounded-xl sm:rounded-2xl overflow-hidden bg-white dark:bg-slate-900">
            <CardHeader className="pb-3 sm:pb-4 border-b border-slate-100 dark:border-slate-800 bg-gradient-to-r from-slate-50 to-purple-50/50 dark:from-slate-800/50 dark:to-slate-800/30 px-4 sm:px-6 py-3 sm:py-4">
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 sm:w-10 h-8 sm:h-10 rounded-lg sm:rounded-xl bg-purple-100 dark:bg-purple-900/50 flex items-center justify-center flex-shrink-0">
                  <FileText className="h-4 sm:h-5 w-4 sm:w-5 text-purple-600 dark:text-purple-400" />
                </div>
                <CardTitle className="text-base sm:text-lg font-semibold text-slate-800 dark:text-slate-100">
                  Documents
                </CardTitle>
          ...
          {/* Action Buttons */}
          <div className="flex flex-col-reverse sm:flex-row justify-end gap-3 sm:gap-4 pt-2 pb-6 sm:pb-8">
            <Button
              variant="outline"
              onClick={handleSaveDraft}
              className="px-6 sm:px-8 h-10 sm:h-12 rounded-lg sm:rounded-xl text-sm border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-800 text-slate-600 dark:text-slate-300 font-medium"
            >
              Save Draft
            </Button>
            <Button
              onClick={handleProceed}
              className="px-6 sm:px-10 h-10 sm:h-12 rounded-lg sm:rounded-xl text-sm bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 dark:from-blue-600 dark:to-blue-700 dark:hover:from-blue-700 dark:hover:to-blue-800 text-white font-medium shadow-lg shadow-blue-500/30 dark:shadow-blue-950/50 transition-all hover:shadow-xl hover:shadow-blue-500/40 dark:hover:shadow-blue-950/60"
            >
              Proceed to Review
