      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p className="text-lg text-white/60 mb-12 max-w-xl mx-auto leading-relaxed">
            Discover opportunities matching your skills and aspirations from top
            companies globally.
          </p>
          ...
          <form onSubmit={handleSearch} className="mb-10">
            <div
              ref={searchRef}
              className="relative bg-white rounded-2xl p-2 shadow-2xl shadow-black/20 flex flex-col sm:flex-row items-stretch sm:items-center gap-2 max-w-2xl mx-auto"
            >
              {/* Job Search Input */}
                      ...
                      <>
                        ...
                        {filteredSuggestions.titles.length > 0 && (
                          <div className="p-4 border-b border-border">
                            ...
                            <div className="space-y-1">
                              {filteredSuggestions.titles.map(
                                (title, index) => (
                                  <button
                                    key={index}
                                    type="button"
                        ...
                        {filteredSuggestions.companies.length > 0 && (
                          <div className="p-4 border-b border-border">
                            ...
                            <div className="space-y-1">
                              {filteredSuggestions.companies.map(
                                (company, index) => (
                                  <button
                                    key={index}
                                    type="button"
                        ...
                        {filteredSuggestions.skills.length > 0 && (
                          <div className="p-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                              {filteredSuggestions.skills.map(
                                (skill, index) => (
                                  <button
                                    key={index}
                                    type="button"
          ...
          <div className="flex flex-wrap items-center justify-center gap-3">
            <Button
              ...
              className="rounded-xl bg-white text-foreground border-white hover:bg-white/90 font-medium shadow-lg transition-all hover:-translate-y-0.5 dark:text-black"
            >
